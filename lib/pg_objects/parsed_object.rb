...
require 'pg_objects/parsed_object/base_type'
require 'pg_objects/parsed_object/conversion'
require 'pg_objects/parsed_object/domain'
require 'pg_objects/parsed_object/enum_type'
require 'pg_objects/parsed_object/event_trigger'
require 'pg_objects/parsed_object/extension'
require 'pg_objects/parsed_object/function'
require 'pg_objects/parsed_object/index'
...
require 'pg_objects/parsed_object/policy'
require 'pg_objects/parsed_object/range_type'
require 'pg_objects/parsed_object/rule'
require 'pg_objects/parsed_object/sequence'
